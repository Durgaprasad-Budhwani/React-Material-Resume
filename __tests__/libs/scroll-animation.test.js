...
import ScrollAnimation from "../../src/lib/scroll-animation";
...
describe("ScrollAnimation -", function () {
  ...
  //   waitFor(() => {console.log(scrollAnimation.node.className.includes("zoomIn")); return scrollAnimation.node.className.includes("zoomIn")},
  //     () => {
